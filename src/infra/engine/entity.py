...
class GameObject:
    ...
    def require_component(self, component_type: Type[T]) -> T:
        ...
        if component is None:
            raise ValueError(
                f"GameObject is missing required component: {component_type.__name__}"
            )
    ...
    def render_component_overlays(self, target: RenderTarget) -> None:
        for component in self._components:
            component.render_overlay(target)
